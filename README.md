...
- Utilizes [Hugo extended version 0.164.0](https://github.com/gohugoio/hugo/releases/tag/v0.164.0)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.164.0
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.164.0
```
